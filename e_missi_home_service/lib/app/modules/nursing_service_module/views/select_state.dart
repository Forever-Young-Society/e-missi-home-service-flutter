...
class SelectStateScreen extends GetView<SelectStateController> {
  var onTap;

  @override
  SelectStateScreen({this.onTap});
  ...
  _list() {
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return inkWell(
            ontap: () {
              Get.find<NursingServiceController>().selectedAddressIndex = index;
              controller.update();
            },
            child: Row(
              children: [
                ...
                Get.find<NursingServiceController>().selectedAddressIndex ==
                        index
                    ? AssetImageWidget(
                        imageUrl: ic_check,
        ...
        itemCount: Get.find<NursingServiceController>().locationList!.length);
  }
