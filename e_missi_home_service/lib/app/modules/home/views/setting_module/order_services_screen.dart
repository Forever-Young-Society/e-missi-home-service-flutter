...
class OrderServicesScreen extends GetView<OrderServicesController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<OrderServicesController>(
      init: OrderServicesController(),
      builder: (OrderServicesController controller) {
        return Scaffold(
  ...
  _orderIDView() {
    return Column(
      ...
      children: [
        TextView(
                text:
                    '${strOrderId} ${controller.bookingDetailResponseModel?.detail?.orderId}',
        ...
        orderdescription(
            title:
                'Booking - ${getDateString(controller.bookingDetailResponseModel?.detail?.startTime ?? "")}',
            value:
          ...
          children: [
            ...
            TextView(
                ...
                textStyle: textStyleHeading()
                    .copyWith(color: Colors.black, fontSize: font_17)),
          ],
  ...
  _commonButton() {
    return MaterialButtonWidget(
      ...
      buttonText: strPayNow,
      fontsize: font_18,
      onPressed: () {
        controller.hitBookingPaymentApiCall();
      },
    ).paddingOnly(bottom: margin_10, top: margin_10);
  }
